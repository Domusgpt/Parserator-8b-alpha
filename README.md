...
- Stream parse progress with `parseStream()` to consume start/stage/plan events and the final response in real time—perfect for chatty agents, dashboards, or CLI vibes that want incremental updates without reimplementing telemetry plumbing.【F:active-development/packages/core/src/index.ts†L216-L363】【F:active-development/packages/core/src/types.ts†L300-L344】
