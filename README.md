...
- Bolt on a lean LLM fallback resolver that batches unresolved fields into a single async call, respects optional-field guardrails, and stays wired to the shared task queue for observability.【F:active-development/packages/core/src/index.ts†L190-L259】【F:active-development/packages/core/src/llm-resolver.ts†L1-L214】
