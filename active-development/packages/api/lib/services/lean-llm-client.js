...
class LeanLLMClient {
    ...
    buildPrompt(request) {
        ...
        lines.push('', 'Return strictly valid JSON with the following shape:', '{"value": <any>, "confidence": <number between 0 and 1>, "reason": "<short explanation>"}', 'Do not include Markdown fences or additional commentary.', '', 'Document:', '"""', request.input, '"""');
        return lines.join('\n');
    }
