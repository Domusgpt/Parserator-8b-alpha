...
function buildSearchInstruction(humanKey, validationType, instructions, context) {
    const parts = [];
...
function buildPlannerSteps(outputSchema, instructions, options, config, context) {
    return Object.keys(outputSchema).map(field => {
        ...
        const searchInstruction = buildSearchInstruction(humanKey, validationType, instructions, context);
        return {
            targetKey: field,
