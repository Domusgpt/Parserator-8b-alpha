...
export declare class ParseratorCore {
    ...
    private emitFieldFallbackTelemetry;
    private planCache?;
    private readonly interceptors;
    private readonly preprocessors;
    private readonly postprocessors;
    private leanLLMPlanRewriteOptions?;
    private leanLLMFieldFallbackOptions?;
    private leanLLMFieldFallbackResolver?;
    ...
    private reapplyLeanLLMFieldFallbackResolver;
