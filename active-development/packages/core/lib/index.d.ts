...
import { ArchitectAgent, ExtractorAgent, ParseRequest, ParseResponse, ParseratorCoreConfig, ParseratorCoreOptions, ParseratorProfileOption, ParseratorSessionInit, ParseratorInterceptor } from './types';
export * from './types';
...
export declare class ParseratorCore {
    ...
    parse(initialRequest: ParseRequest): Promise<ParseResponse>;
