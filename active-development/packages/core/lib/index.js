...
exports.RegexExtractor = exports.HeuristicArchitect = exports.ParseratorCore = void 0;
    ...
    async parse(request) {
        ...
        if (!extractorResult.success || !extractorResult.parsedData) {
            const fallbackDiagnostic = {
                field: '*',
                stage: 'extractor',
                message: extractorResult.error?.message ||
        ...
        const confidence = clamp(architectResult.confidence * 0.35 + extractorResult.confidence * 0.65, 0, 1);
