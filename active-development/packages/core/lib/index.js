...
class ParseratorCore {
    ...
    async executeParse(request, runtime = {}) {
        const requestId = runtime.requestId ?? (0, uuid_1.v4)();
    ...
    createResponseEvent(response, requestId) {
        return {
            type: 'parse:response',
            source: 'core',
            requestId,
    ...
    async notifyStream(event, listener) {
        if (!listener) {
            return;
        }
        try {
