...
class LeanLLMResolver {
    ...
    resolveRuntimeConfig(context) {
        ...
        return {
            ...
            maxInvocationsPerParse: overrides?.maxInvocationsPerParse ?? this.maxInvocationsPerParse,
    ...
    toResolution(context, response, runtime) {
        const baseConfidence = (0, utils_1.clamp)(response.confidence ?? runtime.defaultConfidence, 0, 1);
    ...
    shouldInvoke(context, plan, runtime) {
        ...
        if (runtime.maxInvocationsPerParse !== undefined &&
            ...
            this.recordLimitSkip(context, 'invocations', runtime.maxInvocationsPerParse, summary.totalInvocations, runtime, summary);
    ...
    tryReuseSharedExtraction(context, runtime) {
        ...
        const confidence = (0, utils_1.clamp)(existing.confidence ?? runtime.defaultConfidence, 0, 1);
        const diagnostics = [
            {
                field: context.step.targetKey,
                stage: 'extractor',
    ...
    ensureUsageSummary(shared, runtime) {
    ...
    applySummaryConfigMetadata(summary, runtime) {
        if (runtime.planConfidenceGate !== undefined) {
    ...
    recordPlanGateSkip(context, plannerConfidence, runtime) {
        const summary = this.ensureUsageSummary(context.shared, runtime);
    ...
    recordLimitSkip(context, type, limit, currentValue, runtime, summaryOverride) {
    ...
    recordInvocationOutcome(context, response, confidence, sharedKeys, runtime) {
        const summary = this.ensureUsageSummary(context.shared, runtime);
    ...
    recordInvocationError(context, message, runtime) {
        const summary = this.ensureUsageSummary(context.shared, runtime);
        summary.totalInvocations += 1;
        const entry = {
            field: context.step.targetKey,
    ...
    recordReuse(context, extraction, confidence, runtime) {
        const summary = this.ensureUsageSummary(context.shared, runtime);
