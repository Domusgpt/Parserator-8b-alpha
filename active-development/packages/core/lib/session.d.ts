import { ArchitectAgent, CoreLogger, ExtractorAgent, ParseResponse, ParseratorCoreConfig, ParseratorSessionInit, ParseratorSessionSnapshot, ParseratorTelemetry, ParseratorInterceptor, SessionParseOverrides } from './types';
...
export declare class ParseratorSession {
    ...
    private handleInterceptedResponse;
    private getConfig;
    private ensurePlan;
    private clonePlan;
