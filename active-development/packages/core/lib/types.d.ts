...
export type ParseratorConfidenceTrend = 'increasing' | 'decreasing' | 'stable';
export type ParseratorPlanRecommendation = 'monitor' | 'refresh_plan' | 'reseed_plan';
export interface ParseratorPlanHealth {
    ready: boolean;
    planVersion?: string;
    ...
    confidenceTrend: ParseratorConfidenceTrend;
    lastSuccessAt?: string;
    lastFailureAt?: string;
    recommendation: ParseratorPlanRecommendation;
    notes: string[];
}
