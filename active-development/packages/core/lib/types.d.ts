...
export interface ParseratorStreamResponseEvent extends ParseratorTelemetryBaseEvent {
    type: 'parse:response';
    response: ParseResponse;
}
export type ParseratorStreamEvent = ParseratorTelemetryEvent | ParseratorStreamResponseEvent;
export type ParseratorStreamListener = (event: ParseratorStreamEvent) => void | Promise<void>;
