...
export interface ParseratorInterceptor {
  beforeParse?(context: ParseratorInterceptorContext):
    | void
    | ParseratorInterceptorBeforeResult
    | Promise<void | ParseratorInterceptorBeforeResult>;
  afterParse?(context: ParseratorInterceptorSuccessContext):
    | void
    | ParseratorInterceptorAfterResult
    | Promise<void | ParseratorInterceptorAfterResult>;
  onFailure?(context: ParseratorInterceptorFailureContext):
    | void
    | ParseratorInterceptorFailureResult
    | Promise<void | ParseratorInterceptorFailureResult>;
}
