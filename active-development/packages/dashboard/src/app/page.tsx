...
import ParseratorVisualizer from './components/ParseratorVisualizer';
        ...
        <section className="mx-auto max-w-6xl px-6 pb-24 pt-20">
          <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            ...
            <div className="relative">
              <div className="glass-panel relative overflow-hidden rounded-3xl border border-cyan-500/20">
                <ParseratorVisualizer className="h-[22rem] w-full sm:h-[24rem] lg:h-[26rem]" />
                <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-6">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.3em] text-sky-200/80">Live parse telemetry</p>
                      <h2 className="mt-2 text-2xl font-semibold text-white">Session Visualizer</h2>
                    </div>
                    <span className="flex items-center gap-2 rounded-full bg-emerald-500/25 px-3 py-1 text-xs font-semibold text-emerald-200">
                      <span className="h-2 w-2 animate-pulse rounded-full bg-emerald-300" /> Live
                    </span>
                  </div>
                  <div className="rounded-2xl border border-cyan-500/30 bg-slate-950/70 p-4 text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-200/70 backdrop-blur">
                    <div className="flex flex-wrap items-center justify-between gap-3 text-center">
                      <span className="flex-1 min-w-[120px] text-cyan-100/80">95% Accuracy</span>
                      <span className="hidden h-3 w-px bg-cyan-500/30 sm:block" aria-hidden />
                      <span className="flex-1 min-w-[120px] text-cyan-100/80">70% Token Savings</span>
                      <span className="hidden h-3 w-px bg-cyan-500/30 sm:block" aria-hidden />
                      <span className="flex-1 min-w-[120px] text-cyan-100/80">~2.2s Median Latency</span>
                    </div>
                  </div>
                </div>
              </div>
