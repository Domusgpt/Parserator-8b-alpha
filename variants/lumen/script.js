document.addEventListener('DOMContentLoaded', () => {
  ...
  const usageConfig = {
    rest: {
      ...
      body:
        'POST transcripts with your schema definitions. Parserator returns structured JSON with telemetry and confidence metadata.',
      list: [
        'Schema + raw input in a single call',
        'Confidence + token telemetry included',
  ...
  -d '{\n    "inputData": "Acme Co. Contract Signed 3/12/24",\n    "outputSchema": {\n      "company": "string",\n      "event": "string",\n      "date": "date"\n    }\n  }'`,
    ...
    node: {
      ...
      body:
        'Install the Node SDK for the same Architect → Extractor pipeline with retries, telemetry, and confidence scoring handled for you.',
      list: [
        'npm install @parserator/node-sdk',
        'Architect → Extractor parity across surfaces',
        'Confidence and token metadata included',
      ],
